...
// //   return (
// //     <main className="min-h-screen bg-gray-900 p-4 md:p-6 font-sans antialiased text-gray-100">
...
// //         <section className="mb-16 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
// //           {/* LEFT: Create Classroom */}
// //           <div>
// //             <h2 className="text-lg font-medium text-neutral-200 mb-4 tracking-tight">
// //               Create a classroom
// //             </h2>
...
// //                 className="w-full bg-transparent text-white border border-neutral-800 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-neutral-500 focus:ring-1 focus:ring-neutral-500 transition-all placeholder-neutral-600"
// //               />
// //               <input
// //                 type="text"
...
// //                 className="self-start bg-white hover:bg-neutral-200 disabled:bg-neutral-800 disabled:text-neutral-500 text-black px-6 py-2.5 rounded-lg text-sm font-medium transition-colors mt-1"
// //               >
...
// //                 className="w-full bg-transparent text-white border border-neutral-800 rounded-lg px-4 py-2.5 text-sm font-mono focus:outline-none focus:border-neutral-500 focus:ring-1 focus:ring-neutral-500 transition-all placeholder-neutral-600 font-sans"
// //               />
// //               <button
// //                 type="submit"
// //                 disabled={isJoining || !joinCode.trim()}
// //                 // Using a slightly more muted button for the secondary action to balance the UI
// //                 className="self-start bg-neutral-800 hover:bg-neutral-700 disabled:bg-neutral-900 disabled:text-neutral-600 text-white border border-neutral-700 px-6 py-2.5 rounded-lg text-sm font-medium transition-colors mt-1"
// //               >
...
// //         {/* Section 2: List (H2) -> Cards (H3) */}
// //         <section>
// //           <div className="mb-5 border-b border-gray-800 pb-2">
...
// //                 <div
// //                   key={n}
// //                   className="bg-gray-800 border border-gray-700 rounded-lg p-5 h-40 animate-pulse"
// //                 >
...
// //                 <article
// //                   key={classroom._id}
// //                   className="bg-gray-800 border border-gray-700 rounded-lg p-5 flex flex-col"
// //                 >
// //                   <div className="flex-grow">
// //                     {/* Item Level: H3 */}
// //                     <h2 className="text-xl font-medium capitalize text-white mb-2">
// //                       {classroom.title}
// //                     </h2>
...
//           {/* Reduced from text-5xl to text-3xl to keep it professional */}
...
//                 value={title}
//                 onChange={(e) => setTitle(e.target.value)}
//                 // Replaced neutral/transparent with solid gray inputs
//                 className="w-full bg-gray-900 text-white border border-gray-700 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:border-gray-500 transition-colors placeholder-gray-500"
//               />
//               <input
//                 type="text"
//                 placeholder="Description (optional)"
...
//                 className="self-start bg-white hover:bg-gray-200 disabled:bg-gray-700 disabled:text-gray-500 text-gray-900 px-6 py-2.5 rounded-lg text-sm font-medium transition-colors mt-1"
//               >
//                 {isSubmitting ? "Creating..." : "Create"}
//               </button>
//             </form>
...
//                 value={joinCode}
//                 onChange={(e) => setJoinCode(e.target.value)}
//                 className="w-full bg-gray-900 text-white border border-gray-700 rounded-lg px-4 py-2.5 text-sm font-mono focus:outline-none focus:border-gray-500 transition-colors placeholder-gray-500"
//               />
//               <button
//                 type="submit"
//                 disabled={isJoining || !joinCode.trim()}
//                 // Secondary action: Muted gray button
//                 className="self-start bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 disabled:text-gray-500 text-white border border-gray-600 disabled:border-gray-700 px-6 py-2.5 rounded-lg text-sm font-medium transition-colors mt-1"
//               >
//                 {isJoining ? "Joining..." : "Join"}
//               </button>
//             </form>
...
//             {/* Unified heading size to match Section 1 */}
...
//                 <div
//                   key={n}
//                   className="bg-gray-800 border border-gray-700 rounded-xl p-6 h-40 animate-pulse"
//                 >
//                   <div className="h-5 bg-gray-700 rounded w-2/3 mb-4"></div>
//                   <div className="h-4 bg-gray-700 rounded w-full mb-2"></div>
//                   <div className="h-4 bg-gray-700 rounded w-4/5"></div>
...
//                 <article
//                   key={classroom._id}
//                   className="bg-gray-800 border border-gray-700 rounded-xl p-6 flex flex-col hover:border-gray-500 transition-colors"
//                 >
//                   <div className="flex-grow">
//                     {/* Fixed: Reverted from H2 back to H3 for proper semantics */}
//                     <h3 className="text-lg font-medium capitalize text-white mb-2">
//                       {classroom.title}
//                     </h3>
//                     <p className="text-gray-400 text-sm mb-4 line-clamp-2">
//                       {classroom.description || "No description provided."}
